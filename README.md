...
```clojure
{:user {:plugins [[jonase/eastwood "0.7.0"]]}}
```
...
```clojure
:profiles {:dev {:dependencies [[jonase/eastwood "0.7.0" :exclusions [org.clojure/clojure]]]}}
```
...
Then add `[jonase/eastwood "0.7.0"]` (or whatever is the
