...
- Inconsistencies between file names and the namespaces declared
  ...
  disabled). [[more]](https://github.com/jonase/eastwood/blob/master/README.next.md#check-consistency-of-namespace-and-file-names)
- `:misplaced-docstrings` - Function or macro doc strings placed after
  ...
  they
  belong. [[more]](https://github.com/jonase/eastwood/blob/master/README.next.md#misplaced-docstrings)
- `:deprecations` - Deprecated Clojure Vars, and deprecated Java
  instance methods, static fields, static methods, and
  constructors. [[more]](https://github.com/jonase/eastwood/blob/master/README.next.md#deprecations)
- `:redefd-vars` - Redefinitions of the same name in the same
  namespace. [[more]](https://github.com/jonase/eastwood/blob/master/README.next.md#redefd-vars)
- `:def-in-def` - def's nested inside other
  def's. [[more]](https://github.com/jonase/eastwood/blob/master/README.next.md#def-in-def)
- `:wrong-arity` - Function calls that seem to have the wrong number
  of
  arguments. [[more]](https://github.com/jonase/eastwood/blob/master/README.next.md#wrong-arity)
- `:bad-arglists` - Function/macro `:arglists` metadata that does not
  match the number of args it is defined with (new in version
  0.1.1). [[more]](https://github.com/jonase/eastwood/blob/master/README.next.md#bad-arglists)
- `:suspicious-test` - Tests using `clojure.test` that may be written
  incorrectly. [[more]](https://github.com/jonase/eastwood/blob/master/README.next.md#suspicious-test)
...
- `:unused-ret-vals` and `:unused-ret-vals-in-try` - Unused values,
  ...
  value. [[more]](https://github.com/jonase/eastwood/blob/master/README.next.md#unused-ret-vals)
- `:local-shadows-var` - A local name, e.g. a function arg or let
  ...
  0.1.5). [[more]](https://github.com/jonase/eastwood/blob/master/README.next.md#local-shadows-var)
- `:wrong-tag` - An incorrect type tag for which the Clojure compiler
  does not give an error (new in version 0.1.5). [[more]](https://github.com/jonase/eastwood/blob/master/README.next.md#wrong-tag)
...
- `:keyword-typos` - Keyword names that may be typos because they
  ...
  default). [[more]](https://github.com/jonase/eastwood/blob/master/README.next.md#keyword-typos)
